    ...
    Public Function FindMessageID(ByRef MessageID As String, ByRef TakeABreak As Boolean) As Boolean
        ...
        Try
            ...
            If Len(MessageID) > 0 And TakeABreak = False Then
                ...
                With DManager
                    ds = .GetDataSet(sql)
                    If Not ds Is Nothing And Not ds.Tables(0) Is Nothing And Not ds.Tables(0).Rows Is Nothing Then
                        If CLng(ds.Tables(0).Rows.Count) > 0 Then
                            strMsgID = ds.Tables(0).Rows(0).Item("MessageID")
                            strMsgID = Trim(strMsgID)
                            If Len(strMsgID) > 0 Then
                                FindMessageID = True
                            End If
                        End If
                    End If
