...
Public Class IntegrationParser
                    ...
                    Else ' process accordingly
                        ...
                        Try
                            ...
                            With DManager
                                    ...
                                    "   ModifiedBy = 'MS AX', ModifiedDateTime = DATEADD(hh,4,getdate()), IsRead = 0 WHERE TicketID_Display = '" & _
                                                sTicketID & "' "
                                ' " & SQLTicketChangesString & "
            ...
            With DManager
                ...
                If Not ds Is Nothing Then
                    If ds.Tables(0).Rows.Count > 0 Then
                        ...
                        .ExecuteSQL(sql)
                        WriteToEventLog("CIM Service: Function IncrementTicketNumberSequence #04", EventLogEntryType.Information)
    ...
    Public Function FindMessageID(ByVal MessageID As String, ByRef TakeABreak As Boolean) As Boolean
        ...
        Try
            ...
            End If
            If Debug_Mode Then
                sEventEntry = "CIM Service: Function FindMessageID returns " & Convert.ToString(FindMessageID) & vbCrLf & "This is a "
                If FindMessageID = False Then
                    sEventEntry = sEventEntry & "NEW e-mail" & vbCrLf
                Else
                    sEventEntry = sEventEntry & "previously read e-mail" & vbCrLf
                End If
                sEventEntry = sEventEntry & "Parameter TakeABreak passed ByRef: " & Convert.ToString(TakeABreak) & vbCrLf _
                    & "Message ID: " & Chr(39) & Trim(strMsgID) & Chr(39) & vbCrLf & vbCrLf & "SQL: " & sql
                ...
                If FindMessageID = False Then WriteToEventLog(sEventEntry, EventLogEntryType.Information)
            End If
        Catch ex As Exception
            TakeABreak = True
            sEventEntry = "CIM Service Exception: Function FindMessageID, returns " & Convert.ToString(FindMessageID) & vbCrLf _
                & "Parameter TakeABreak passed ByRef: " & Convert.ToString(TakeABreak) & vbCrLf _
                & "Message ID: " & Chr(39) & MessageID & Chr(39) & vbCrLf _
                & "Target: " & ex.TargetSite.ToString() & vbCrLf _
                & "Message: " & ex.Message
            WriteToEventLog(sEventEntry, EventLogEntryType.Error)
        End Try
